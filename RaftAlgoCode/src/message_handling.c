...
void handle_list_broadcast_message(char *msg){
	...
	printf("Test 1\n");
	int *global_network_ids = get_broadcast_ids_from_msg(broadcast_network_ids, msg, num_ids);
	get_broadcast_ids_from_msg(broadcast_network_ids, num_ids, network_ids, 2, id)
	printf("Test 2\n");
